        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="event-image mb-4" data-aos="fade-up">
                    <img src="{{ $jurusan->gambar ? asset('public/themes/' . $jurusan->gambar) : asset('themes/frontend/assets/img/default.png') }}"
                    ...
                    <div class="sidebar-widget organizer-info" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div class="organizer-details">
                            <div class="organizer-image">
                                <img src="{{ $jurusan->ketuaJurusan && $jurusan->ketuaJurusan->foto ? asset('public/themes/' . $jurusan->ketuaJurusan->foto) : asset('themes/frontend/assets/img/default.png') }}"
        ...
        <div class="row">
            <div class="event-gallery mt-5" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="row g-4 mt-2">
                    ...
                    <div class="col-md-3">
                        <a href="{{ $course->gambar ? asset('public/themes/' . $course->gambar) : asset('themes/frontend/assets/img/default.png') }}"
                            class="glightbox">
                            <img src="{{ $course->gambar ? asset('public/themes/' . $course->gambar) : asset('themes/frontend/assets/img/default.png') }}"
