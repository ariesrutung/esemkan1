        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="event-image mb-4" data-aos="fade-up">
                    <img src="{{ $informasi->gambar ? (str_contains($informasi->gambar, '/') ? asset('public/themes/' . $informasi->gambar) : asset('themes/frontend/assets/img/informasi/' . $informasi->gambar)) : asset('public/themes/default.png') }}"
