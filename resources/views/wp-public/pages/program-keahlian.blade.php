                    ...
                    <div class="alumni-profile">
                        <div class="profile-header">
                            <div class="profile-img">
                                <img src="{{ $item->gambar ? (str_contains($item->gambar, '/') ? asset('public/themes/' . $item->gambar) : asset('themes/frontend/assets/img/program-studi/' . $item->gambar)) : asset('public/themes/default.png') }}"
