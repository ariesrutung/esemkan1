        ...
        <div class="row align-items-top g-5">
            ...
            <div class="col-lg-6">
                <div class="about-image" data-aos="zoom-in" data-aos-delay="300">
                    <img src="{{ asset('themes/frontend/assets/img/education/akreditasi.png') }}" alt="Campus"
                    ...
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 g-4">
                        <div class="col">
                            <div class="value-card">
                                ...
                                <h4>VISI</h4>
                                <p>{{ $identities['visi'] ?? 'Visi Sekolah' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="value-card">
                                ...
                                <h4>MISI</h4>
                                <p>Membangun hubungan harmonis dan kemitraan aktif dengan masyarakat, dunia usaha,
                                    industri, dan
                                    pemerintah guna mendukung pengembangan pendidikan dan kompetensi siswa.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-12 mt-5" data-aos="fade-right" data-aos-delay="200">
                            <h3 class="text-center mb-4">Tujuan</h3>
