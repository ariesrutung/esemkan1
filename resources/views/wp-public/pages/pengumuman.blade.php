...
@section('content')
<section id="events-2" class="events-2 section mt-5">
                ...
                <div class="events-list">
                    <div class="event-item" data-aos="fade-up">
                        ...
                        <div class="event-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. Proin gravida dolor sit amet lacus accumsan.</p>
                    ...
                    <div class="event-item" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="event-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec
                                ullamcorper mattis, pulvinar dapibus leo. Proin sagittis nisl rhoncus mattis rhoncus.
                            </p>
                            <a href="#" class="btn-event">Learn More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div><!-- End Event Item -->
                    ...
                    <div class="event-item" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="event-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur non nulla sit amet
                                nisl tempus convallis quis ac lectus. Mauris blandit aliquet elit, eget tincidunt nibh
                                pulvinar a.</p>
                            <a href="#" class="btn-event">Learn More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div><!-- End Event Item -->
                    ...
                    <div class="event-item" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="event-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque in ipsum id orci
                                porta dapibus. Vivamus suscipit tortor eget felis porttitor volutpat. Vestibulum ante
                                ipsum primis.</p>
                            <a href="#" class="btn-event">Learn More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div><!-- End Event Item -->
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-item featured-event" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="featured-event-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget tortor risus
