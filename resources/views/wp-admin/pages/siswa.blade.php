                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img class="rounded-circle"
                                            src="{{ str_contains($item->foto, '/') ? asset('public/themes/' . $item->foto) : asset('themes/frontend/assets/img/siswa/' . $item->foto) }}"
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->foto)
                            <img src="{{ str_contains($item->foto, '/') ? asset('public/themes/' . $item->foto) : asset('themes/frontend/assets/img/siswa/' . $item->foto) }}" width="200">
                            @else
                            Tidak ada foto
                            @endif
                        </td>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            @if($item->foto)
                            <div class="mt-2">
                                <img src="{{ str_contains($item->foto, '/') ? asset('public/themes/' . $item->foto) : asset('themes/frontend/assets/img/siswa/' . $item->foto) }}" width="100">
                            </div>
                            @endif
                        </div>
                    </div>
