...
<body class="sb-nav-fixed">
    ...
    <script src="{{ asset('themes/backend/assets/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('themes/backend/assets/demo/chart-bar-demo.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js"
        crossorigin="anonymous"></script>
    <script src="{{ asset('themes/backend/js/datatables-simple-demo.js') }}"></script>
</body>
